...
<table class="commission_table commission_details">
    <tr>
        <td colspan="2" style="font-size: 18px; font-weight:bold; color:#D18359">Checks In</td>
    </tr>
    <tr>
        <td width="220"><strong>Commission Check Received:</strong></td>
        <td><?php echo date_show($com[0]['date_received']); ?></td>
    </tr>
    ...
    <tr>
        <td colspan="2" style="border:none"><table width="100%">
                <tr>
    ...
    <tr>
        <td colspan="2" style="border:none; font-size:13px; color: #A84549;">We cannot process your commission until we have received the Closing Disclosures and Commission Breakdown</td>
    </tr>
</table>
<?php } ?>
<?php if($show == 'yes') { ?>
<table>
    <tr>
        ...
        <td><?php echo date_show($com[0]['date_deposited']); ?></td>
    </tr>
    <tr>
        <td colspan="2"><hr></td>
    </tr>
    <tr>
        <td colspan="2" style="font-size: 18px; font-weight:bold; color:#D18359">Checks Out</td>
    </tr>
</table>
<table>
    <tr>
	...
	if($com[0]['recip'.$i.'_check_amount'] != '' && $com[0]['recip'.$i.'_check_amount'] != '0.00' && $com[0]['recip'.$i.'_check_amount'] > 0) {
		...
		if($com[0]['recip'.$i.'_id'] != '' && $com[0]['recip'.$i.'_id'] != 0) {
			$agentQuery = "SELECT * from company.tbl_agent where id = '".$com[0]['recip'.$i.'_id']."'";
