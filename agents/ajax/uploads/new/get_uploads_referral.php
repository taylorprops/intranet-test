...
<table border="0" width="100%" id="commission_table" cellspacing="0">
    ...
    <tbody>
        <?php for($c=0;$c<$comCount;$c++) {
            ...
            $uploadQuery = "SELECT * FROM company.commission_uploads where group_id = '".$com[$c]['group_id']."'"; 
        ...
        <tr class="<?php echo $class; ?>">
            ...
            <td>
                ...
                <a href="<?php echo $upload[$u]['upload_loc']; ?>" target="_blank" class="dark"><?php echo $upload[$u]['file_name']; ?></a><br>
                <?php } ?>
            </td>
            <td width="50" align="center">
                <?php if($com[$c]['processed'] == 'no') { ?>
                <a class="button button_cancel delete_referral_commission_button" href="javascript: void(0)" data-referral_id="<?php echo $com[$c]['id']; ?>">
                </a>
                <?php } ?>
            </td>
        </tr>
