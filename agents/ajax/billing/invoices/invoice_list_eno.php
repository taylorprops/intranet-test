...
and 
(in_type like '%charge%' or in_type like '%refund%' or in_type like 'late%' or (in_type like '%payment%' and in_paid = 'yes')) and in_type like '%eno%'  
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="invoice_list" width="100%">
		...
		for($i=0;$i<count($invoice);$i++) {
            ...
            <tr bgcolor="<?php echo $color; ?>">
                ...
                <td align="center">$<?php echo $invoice[$i]['in_agent_balance_eno']; ?></td>
            </tr>
        <?php
        } ?>
        </tbody>
