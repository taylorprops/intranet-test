    ...
    <table width="650" cellpadding="0" cellspacing="0" style="font-family:Arial;font-size:15px; color:#003366">
        ...
        <tr>
            <td style="border:1px solid #2D7FA4; padding:10px;"> Welcome <?php echo $first; ?>,<br>
                This email is to inform you about our employee website and its features.<br />
                <br />
                <i>Please be sure to add your photo and bio which will appear in our Agent section on our public site</i> <br />
                <br />
                <span style="font-size:18px; font-weight:bold; text-decoration:underline;">Employee Website</span> <br />
                <br />
                Our employee website can be accessed by going to <a href="https://annearundelproperties.net">www.AnneArundelProperties.net</a>.<br />
                <br />
                <strong>Login Information</strong><br>
                Username: <?php echo $email; ?><br>
                Password:  To retrieve you password go to the login page <a href="https://annearundelproperties.net">Here</a> and click on the link that says "<strong>Forgot your Password? Click HERE</strong>"<br>
                ...
                <ul>
                    ...
                    <blockquote style="border:1px solid #333333; padding:5px;"> Invoices will be sent on the 27th of each month (every 3rd month if   your are on quarterly billing) and balances will be applied to your account.<br>
                        ...
                        <br>
                        All accounts with balances remaining after the 5th will be billed a  $25 late fee.</blockquote>
                    <li>Update Your Information
                        <ul>
                            <li>Add your photo and bio for public company website</li>
                        </ul>
                    </li>
