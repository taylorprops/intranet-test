...
$formQuery = "select * from company.tbl_forms where category = 'Checklists - Listings' order by state, county, description";
$form = $db -> select($formQuery);
$formCount = count($form);
?>

<div id="table_container">
	<div class="forms_header">Listing Checklists</div>
    <div id="form_tabs">
        <ul>
